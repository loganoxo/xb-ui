<template>
  <div class="user-clause">
    ...
    <template v-if="isShowClause === 'merchant'">
      <h2 class="text-ct mt-46">商家平台服务条款</h2>
      <div class="user-clause-con mt-20">
        <p class="main-color">亲，感谢您成为秀吧商家用户！</p>
        <p class="mt-10 ml-15">本指引非常重要，请您一定认真看完！</p>
        <p class="mt-5 ml-15">在秀吧，商家用户的流程图如下：</p>
        ...
        <p class="mt-10 ml-15 text-indent">在秀吧平台，除了“体验专区”以外，其余板块都要求商家用户拍A发A（秀客在淘宝上拍下是什么商品，商家必须邮寄什么商品！）</p>
        ...
        <p class="mt-22 ml-15 mb-40">真诚希望秀吧平台能帮助到您，祝您生意兴隆！</p>
      </div>
    ...
    <template v-if="isShowClause === 'showker'">
      <h2 class="text-ct mt-46">秀客平台服务条款</h2>
      <div class="user-clause-con mt-20">
        ...
        <p class="text-indent">1.在旺旺上，与商家谈及秀吧平台相关事项的；</p>
        <p class="text-indent">2.还未收到货品的情况下，就去淘宝进行商品评价的；</p>
        <p class="text-indent">3.未跟商家协商的情况下，就申请退款的。</p>
        <p class="mt-12">出现以上重大违规事项，平台将即刻注销您秀客账号，并扣留您所有账户余额！</p>
