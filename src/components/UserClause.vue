  ...
  <div class="user-clause">
    ...
    <template v-if="isShowClause === 'merchant'">
      ...
      <div class="user-clause-con mt-20">
        ...
        <p class="mt-10 ml-15 text-indent">在白拿拿平台，除了“体验专区”以外，其余板块都要求商家用户拍A发A（秀客在淘宝上拍下是什么商品，商家必须邮寄什么商品！）</p>
    ...
    <template v-if="isShowClause === 'showker'">
      ...
      <div class="user-clause-con mt-20">
        <p class="main-color">亲，感谢您成为白拿拿平台的秀客！</p>
        <p class="mt-10 ml-15">本指引非常重要，请您一定认真看完！</p>
        <p class="mt-5 ml-15">在白拿拿，秀客接任务领取商品的流程图如下：</p>
