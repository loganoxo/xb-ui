            ...
            <table>
              ...
              <tr :class="{readBackground:allTask.newest}">
                ...
                <td class="registration">
                  <p class="mt-5 cl666" v-cloak>近七天通过次数：{{allTask.applyCount || 0}}</p>
                  <p v-cloak class="mt-5 mb-5" :style="{color: orderNumberColorTip(allTask.applySuccessCount)}">近七天下单次数：{{allTask.applySuccessCount || 0}}</p>
