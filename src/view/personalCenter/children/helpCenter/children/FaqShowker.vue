  ...
  <div>
    <div class="mt-20">
      <ButtonGroup shape="circle">
        <iButton :ref="faqSel.ref" v-for="(faqSel,index) in faqSelList" :type="faqSel.type" :key="index" @click="selQuestion(faqSel,index)">
          {{faqSel.text}}
        </iButton>
      </ButtonGroup>
    </div>
    <div v-show="selFaq === 'common'" class="faq-que-ans animated fadeIn ">
        ...
        <Collapse class="mt-20" v-model="selectedFaq">
          <Panel name="1">
            1、拿手下单规则：
            <div slot="content">
              <p>1.1、拿手参与下单活动时，须严格按评测详情中的步骤流程进行操作，不允许利用其他方式下单购买，经核查属实，拿手帐号按一类违规处理；</p>
              <p>1.2、拿手下单时，应核对活动商家店铺的旺旺号、以及产品的标题、价格。未核实信息导致下单错误的，将取消本次活动的评测资格，所产生的损失由拿手自行承担； </p>
              <p>1.3、拿手搜索不到对应产品时，应停止操作，以免下单错误，及时向平台客服反应；</p>
              <p>1.4、拿手下单时发现活动产品与店铺产品不一致时（包括价格、标题、属性及活动页面主图），应停止操作，及时向平台客服反应；</p>
              <p>1.5、因商家修改产品价格、标题、属性以及活动页面主图而造成拿手下单错误的，及时向平台客服反应； </p>
            </div>
          </Panel>
          <Panel name="2">
            2、获得免费评测资格后需在多久内下单？
              <p slot="content">
            获得评测资格的拿手，需在24小时内完成下单并将订单号和金额反馈至平台，超时视为自动放弃任务，系统将自动取消任务资格。
            </p>
          </Panel>
          <Panel name="3">
            3、下单需要垫付么
            <p slot="content">
            是的，拿手去到商家店铺购买商品时，需先行垫付，到商品确认收货评价后商家返还垫付资金。
          </p>
          </Panel>
          <Panel name="4">
            ...
            对商家不必要的金钱损失， 白拿拿评测平台视情节严重，对拿手进行对应的处罚，情节严重会进行封号处理。
           </p>
          </Panel>
          <Panel name="5">
            5、商家如何发货？
          ...
          <Panel name="7">
            ...
            <div slot="content">
              <p> 目前平台只保证金返款。商家核实评测报告无误后操作（确认返款），存入的保证金将于操作后打入拿手的平台账户。</p>
            </div>
          </Panel>
          <Panel name="8">
            8、商家什么时候返款？
    ...
    <div v-show="selFaq === 'special'" class="faq-special-explain animated fadeIn ml-5">
        <p>拿手完整流程：1、注册账号 > 2、申请活动 > 3、通过审批 > 4、下单领取 > 5、提交单号 > 6、提交评测报告 > 7、领取评测担保金</p>
        <ul class="faq-special-ctt">
          <li>
            <p class="fs-14 f-b cl000">1、注册账号</p>
            <ul class="faq-special-explain-txt">
              <li>
                第一步：在拿手白拿拿首页或顶部点击“免费注册”，进入注册页面。
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              ...
              <li>
                获得活动资格后，拿手应在24小时内去下单并填写订单号，逾期系统将自动取消拿手的本次活动资格。
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              ...
              <li>
                第二步：返回白拿拿，在“我的活动>已通过”的评测参与活动中点击“填订单号”。。
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              <li>
                拿手收到宝贝后，就可以拍下照片并制作买家秀了。在下单并填写订单号之后，须在12天内提交评测报告，否则系统将自动取消拿手的本次评测资格。
              ...
              <li>
                第三步：买家秀提交成功后，商家会在24小时内审核，状态显示为“买家秀待确认”。

              </li>
              <li>
                注：1、如果商家在24小时内未审核，系统会自动通过买家秀，并给您返还宝贝担保金。
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              <li>
                拿手的买家我由商家审核通过后，活动的宝贝担保金自动返还到拿手的平台账户中。可对平台账户进行提现：
