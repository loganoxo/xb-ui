  ...
  <div class="activity-management">
    ...
    <Modal v-model="evaluateShowker" class="evaluate-showker-pop" @on-visible-change="changeEvaluatePop">
      <div class="pl-20 pr-20 mt-30">
        <div class="cl000">请对拿手<span class="main-color" v-if="showkerTaskInfo.alitm">{{showkerTaskInfo.alitm.alitmAccount}}</span>进行评价<span class="cl666">(你的评价将决定该拿手的整体评分)：</span></div>
