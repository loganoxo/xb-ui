      ...
      <div v-show="selFaq == 'common'" class="faq-que-ans animated fadeIn " >
        ...
        <Collapse class="mt-20" v-model="selectedFaq">
          <Panel name="1" id="q1">
            ...
            <p slot="content">
            注册白拿拿是免费的，拿手成功注册之后可以免费申请试用商品。商家注册成功后可以发布试用商品。
           </p>
          </Panel>
          <Panel name="2" id="q2">
            2、注册成功之后，角色可以修改吗？
        ...
        <ul class="faq-special-ctt">
          <li>
            ...
            <ul class="faq-special-explain-txt">
              <li>
                1、PC搜索下单的拿手必须使用电脑登录taobao.com搜索下单，须严格按试用详情中的步骤流程进行操作，
                不允许利用其他方式下单购买，经核查属实，一经核实将取消该次活动的试用资格，所产生的损失由拿手自行承担。
              </li>
              <li>
                2、拿手下单时，应核对活动商家店铺的旺旺号、以及产品的标题、价格。
                未核实信息导致下单错误的，将取消本次活动的试用资格，所产生的损失由拿手自行承担；
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              ...
              <li>
                2、获得试用资格后，拿手必须使用手机淘宝搜索下单，须严格按试用详情中的步骤流程进行操作，
                不允许利用其他方式下单购买，一经核实将取消该次活动的试用资格，所产生的损失由拿手自行承担。。
              ...
              <li>
                ...
                拿手利用自己的淘宝客链接下单购买赚取佣金，一经核实将取消该次活动的试用资格，所产生的损失由拿手自行承担。
          ...
          <li>
            ...
            <ul class="faq-special-explain-txt">
              ...
              <li>
                2、获得试用资格后，拿手必须使用手机淘宝下单，若不按流程参与，一经核实将取消该次活动的试用资格，所产生的损失由拿手自行承担。
              ...
              <li>
                ...
                若核实拿手利用自己的淘宝客链接下单购买赚取佣金，一经核实将取消该次活动的试用资格，所产生的损失由拿手自行承担。
