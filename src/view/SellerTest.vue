            ...
            answer: [
              {
                ...
                state: 'unselected',
                key: 'A',
                desc: '18年刷单立法，你还敢刷吗？用秀吧，走免费试用吧！（秀吧安全保障措施详见第二题）',
              },
              {
                text: '人群标签',
                state: 'unselected',
          ...
          },
          {
            ...
            answer: [
              ...
              },
              {
                ...
                state: 'unselected',
                key: 'C',
                desc: 'A、商家挑选买家：申请买家信息全透明，买家是否通过做任务，全部由商家决定 B、访问深度,行为透明：1-4天重复访问、收藏加购、货比三家等，均需截图上传 C、千人千面，定向推广：根据商家产品属性，定向推广符合标签的秀客人群 ',
              },
              {
                text: '服务到位',
                state: 'unselected',
