<template>
  <div>
        ...
        <div class="task-details-top">
          ...
          <div class="task-details-top-right left">
            ...
            <p class="fs-14">{{commodityData.task.showkerApplyTotalCount}} 人申请，{{parseInt(commodityData.trailOn) ?
              ...
              人完成活动， 剩余 {{commodityData.task.taskCount - commodityData.task.showkerApplySuccessCount}} 份
    ...
    <Modal
      ...
      <p class="mt-10">本次申请将消耗 <span class="main-color"> “1次” </span> 申请次数，当前您的剩余次数为 <span class="clff6633"> “{{residue}}次” </span> </p>
      <div class="mt-10">
