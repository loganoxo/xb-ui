      ...
      <div class="container">
        <div class="task-details-top">
          ...
          <div class="task-details-top-right left">
            ...
            <p class="f-b cl000 fs-14" v-if="commodityData.task.createTime>=1526464800000">该活动可额外获得打赏费<span v-if="commodityData.task.activityCategory === 'free_get'">1</span><span v-else-if="commodityData.task.activityCategory === 'present_get'">2</span>元</p>
            <p class="f-b cl000 fs-14" v-else>该活动可额外获得打赏费0元</p>
